                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-8 pt-2">
                                <h4><i class="fa fa-list" aria-hidden="true"></i> List Sales Order</h4>
                            </div>
            ...
            columns: [{
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        return row.so_date.split('T')[0]
                    }
                }, {
                    "data": null,
                    "render": function(data, type, row) {
                        return '<div class="btn-group" role="group" aria-label=""><a href="{{ url('sales/order') }}/' +
                            row.so_token +
