    ...
    <div class="row bg-light" style="max-width:104%">
        ...
        <div class="col-12 col-md-9 col-lg-10 pt-2">
            <nav class="nav nav-tabs nav-stacked justify-content-end">
                <a class="nav-link  text-dark {{ Route::currentRouteName() == 'accounting' ? 'active' : '' }}" href="{{route('accounting')}}">Dashboard</a>
                <a class="nav-link  text-dark {{ Route::currentRouteName() == 'setup-user' ? 'active' : '' }}" href="{{route('setup-user')}}">Jurnal Entries</a>
                <a class="nav-link  text-dark {{ Route::currentRouteName() == 'setup-user' ? 'active' : '' }}" href="{{route('setup-user')}}">Reporting</a>
                <a class="nav-link  text-dark {{ Route::currentRouteName() == 'setup-user' ? 'active' : '' }}" href="{{route('setup-user')}}">Setup</a>
