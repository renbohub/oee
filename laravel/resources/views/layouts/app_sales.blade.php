...
<body class="top-navigation" style="background-color: rgb(229, 225, 225)">
    ...
    <div class="row bg-light" style="max-width:104%">
        <div class="col-12 col-md-12 col-lg-12 pt-2 px-4">
            <nav class="nav nav-tabs nav-stacked justify-content-end">
                <a class="nav-link  text-dark {{ Route::currentRouteName() == 'sales' ? 'active' : '' }}" href="{{route('sales')}}">Dashboard</a>
                <a class="nav-link  text-dark {{ Route::currentRouteName() == 'sales-quotation' ? 'active' : '' }}" href="{{route('sales-quotation')}}">Quotation</a>
                <a class="nav-link  text-dark {{ Route::currentRouteName() == 'sales-order' ? 'active' : '' }}" href="{{route('sales-order')}}">Sales Order</a>
                <a class="nav-link  text-dark {{ Route::currentRouteName() == 'sales-invoice' ? 'active' : '' }}" href="{{route('sales-invoice')}}">Invoice</a>
                <a class="nav-link  text-dark {{ Route::currentRouteName() == 'sales-customer' ? 'active' : '' }}" href="{{route('sales-customer')}}">List Customer</a>
                <a class="nav-link  text-dark {{ Route::currentRouteName() == 'warehouse-product' ? 'active' : '' }}" href="{{route('warehouse-product')}}">List Product</a>
            </nav>
        </div>
    </div>
    <div class="">
