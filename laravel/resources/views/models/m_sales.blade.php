                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col-8 pt-2">
                                <i class="fa fa-list-ul " aria-hidden="true"></i> <b>{{$m_tittle}}</b>
                            </div>
                            <div class="col-4 text-right">
                                <a name="" id="" class="btn btn-primary" href="{{$new_route}}"
                                    role="button"><i class="fa fa-plus" aria-hidden="true"></i> {{$m_button}}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
